...
const CATEGORIES = [
  ...
  { title: 'Recent Combat Experience', weight: '15%', desc: 'Assesses whether the country has engaged in a major or minor war over the past five years. Definitions based on the Uppsala Conflict Data Program (UCDP) methodology. Engagement in a major war results in 15 points; engagement in only a minor war results in 5 points. Countries with no qualifying conflict receive 0.' },
  ...
  { title: 'Societal Willingness to Fight', weight: '10%', desc: 'This factor helps explain the readiness of society — and the armed forces as an integral part of it — to fight for their country.' },
];
