...
export const PROFILES = {
  ...
  'United States': {
    ...
    manpower: {
      ...
      conscription: field('No — all-volunteer force', [], false),
  ...
  'Russia': {
    ...
    manpower: {
      ...
      conscription: field('Yes — 12-month conscription for men aged 18–30', [], false),
  ...
  'China': {
    ...
    manpower: {
      ...
      conscription: field('Nominally yes (constitutional obligation), in practice overwhelmingly volunteer force', [], false),
  ...
  'Israel': {
    ...
    manpower: {
      ...
      conscription: field('Yes — mandatory service, ~32 months men / ~24 months women', [], false),
  ...
  'Ukraine': {
    ...
    manpower: {
      ...
      conscription: field('Yes — martial law mobilization since Feb 2022, men 18–60', [], false),
